...
<body>
                    ...
                    <div id="content">
                        <section class="container">
                            <div class="login">
                                ...
                                <form method="post" action="../Kelly/controllers/authentication.php">
  ...
  <br/>
            ...
            <div class="col-lg-8 mt-5 mt-lg-0">
                        ...
                        <form name="myForm" action="../Kelly/controllers/userform.php"   class="php-email-form"method="post" onsubmit="return  validateForm()">
